...
// var paixing = JapaneseMaj.getPaixingFromString('2m2m2p3p4p4s0s 555z 978p');//"1p2p3p4p0p6p7p8p9p6p6p 22222s"
...
let KanCard = new Card(7, 's');
let ShowCards = [];
let ShowCardsCopy = ShowCards.slice();
let showCardsAfterKan = ShowCardsCopy.push({
    Type: 'Ankan',
    Cards: [KanCard, KanCard, KanCard, KanCard]
});
console.log(showCardsAfterKan);